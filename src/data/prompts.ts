...
[PASTE STACK DESCRIPTION]`,
    tip: "Ask it to name the cheapest fix for the first stall, not the most complete one. Tonight's goal is finding the gap, not closing it.",
  },
...
[PASTE CALL NOTES OR RESEARCH]`,
    tip: 'Ask it to write the one message that would work for the primary persona and fail for the negative one. That contrast is what actually confirms the split.',
  },
...
[PASTE TEST IDEA AND BUSINESS QUESTION]`,
    tip: "Run the result through this checklist's Decision Enabled field before the test launches, not after it reports. That field is under the most deadline pressure.",
  },
